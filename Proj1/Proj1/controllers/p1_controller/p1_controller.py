...
# Ground sensor threshold for line detection
GROUND_SENSOR_THRESHOLD = 200

# Standstill detection for early exit
...
class Evolution:
    ...
    def reset(self):
        """Reset robot to random position and orientation"""
    ...
    def runStep(self, weights):
        ...
        # Direct motor control using weights
        ...
        # Get current position for fitness calculations
        ...
        # Line detection and area coverage
