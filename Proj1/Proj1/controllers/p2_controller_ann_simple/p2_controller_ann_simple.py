...
class SimpleANN:
    def __init__(self, weights):
        """Inicializa a rede neuronal artificial simples.
        
        Args:
            weights: Array de pesos para a rede neuronal
        """
        idx = HIDDEN * (INPUT + 1)
    ...
    def forward(self, inputs):
        ...
        Args:
            inputs: Array de entradas para a rede
            
        Returns:
            np.array: Saídas da rede neuronal
        """
...
class Evolution:
    ...
    def runStepLogic(self, ann_model):
        """Executa a lógica de um passo da simulação com modelo ANN.
        
        Args:
            ann_model: Modelo de rede neuronal para controlo do robô
    ...
    def _log_generation_to_csv(self, data):
        ...
        Args:
            data: Lista com dados da geração a registar
        """
